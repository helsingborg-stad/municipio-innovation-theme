...
@section('after-archive-link')
    <div class="grid-xs-12 u-text-right">
        <div class="js-flickity-controller" data-flickity-controller-target="#flickity-mod-posts-{{$ID}}">
            <button class="js-flickity-prev"> <i class="pricon pricon-angle-left"></i></button>
            <button class="js-flickity-next"> <i class="pricon pricon-angle-right"></i></button>
        </div>
    </div>
@stop

@section('loop')
    <div id="flickity-mod-posts-{{$ID}}" class="grid u-w-100" data-flickity-options='{!! $slider['flickityOptions'] !!}'  data-equal-container>
